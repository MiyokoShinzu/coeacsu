...
<div class="position-fixed top-0 start-0 end-0 bg-transparent z-3" style="width: 100vw; margin: 0; padding: 0;">
    <nav class="navbar navbar-expand-lg shadow-sm w-100">
        ...
        <a class="navbar-brand d-flex align-items-center ms-3" href="../">
            ...
            <span class="ms-2 fw-bold subtitle_n" style="font-size: 0.7em; color: #000;">COEA - BSECE</span>
        </a>
...
* {
    ...
    scrollbar-color: var(--bs-bg);      /* thumb and track */
}

/* ==== For WebKit Browsers (Chrome, Edge, Safari) ==== */
::-webkit-scrollbar {
    width: 8px;  /* More visible width */
    height: 8px;
}
