    ...
    <div class="main min-vh-100 w-100">
        ...
        <div class="row d-flex gs-1 mt-1 justify-content-center align-items-center " style="width: 100%; margin: 0 auto;">
            <div class=" col-lg-12  col-md-12 col-sm-12 d-flex align-items-center justify-start flex-column mx-auto mb-3" style="background:<?php echo $bg; ?>">
                <h1 class=" text-center text-white mt-2 p-2" style="font-weight: bolder; font-size: 4em">EXTENSION AND COMMUNITY SERVICE</h1>
                <p class="text-white">Narrative Presentation</p>
            </div>
            <?php
            $sql = "SELECT * FROM files WHERE area = 'Extension' AND section = 'Narrative Presentation' and department='ce' ORDER BY id DESC";
            ...
            <?php
            $sql = "SELECT * FROM files WHERE area = 'Extension' AND section = 'Narrative Report' and department='ce' ORDER BY id DESC";
            $result = $mysqli->query($sql);
            if ($result && $result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
                    $filePath = $row['path']; // assuming this contains relative path like: uploads/ce/basic.pdf
        ...
        <div class="col-lg-7 mx-auto mb-3 mt-3 p-0 row">
            ...
            <div class="col-lg-11 mx-auto mb-3">
                <h6>Campus College RDE Agenda</h6>

                <?php
                // adjust path as needed

                $sql = "SELECT * FROM files WHERE area = 'Extension' AND section = 'Campus College RDE Agenda' and department='ce' ORDER BY id DESC";
                $result = $mysqli->query($sql);
        ...
        <div class="col-lg-11 mx-auto mb-3 d-flex align-items-center text-start text-center border shadow-sm p-1 hover-container"
            ...
            <a href="../admin/handlers/' . htmlspecialchars($filePath) . '" target="_blank" class="text-decoration-none text-dark w-100 hover-link">
                ...
                $sql = "SELECT * FROM files WHERE area = 'Extension' AND section = 'On-going Extension Project' and department='ce' ORDER BY id DESC";
                $result = $mysqli->query($sql);
        ...
        <div class="col-lg-11 mx-auto mb-3 d-flex align-items-center text-start text-center border shadow-sm p-1 hover-container"
            ...
            <a href="../admin/handlers/' . htmlspecialchars($filePath) . '" target="_blank" class="text-decoration-none text-dark w-100 hover-link">
                ...
                ?>
                <h6>Impact Studies of Extension Projects</h6>

                <?php
                // adjust path as needed

                $sql = "SELECT * FROM files WHERE area = 'Extension' AND section = 'Impact Studies of Extension Projects' and department='ce' ORDER BY id DESC";
                $result = $mysqli->query($sql);
        ...
        <div class="col-lg-11 mx-auto mb-3 d-flex align-items-center text-start text-center border shadow-sm p-1 hover-container"
            ...
            <div class="mt-3 col-lg-12 col-md-12 col-sm-12 d-flex align-items-center justify-start flex-column mx-auto mb-3" style="background:<?php echo $bg; ?>">
                <h5 class="text-white p-3">Matrix of Extension Projects</h5>
            </div>
            <?php
            $sql = "SELECT * FROM files WHERE area = 'Extension' AND section = 'Matrix of Extension Project' and department='ce' ORDER BY id DESC";
            $result = $mysqli->query($sql);
            if ($result && $result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
                    $filePath = $row['path']; // assuming this contains relative path like: uploads/ce/basic.pdf
