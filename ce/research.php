...
<body class="position-relative" style="overflow-x: hidden; font-family: 'Poppins', sans-serif;">
    ...
    <div class="main min-vh-100 w-100">
        ...
        <!-- background: #ff4C01; #FE904D-->
         <?php  $bg = "#f17e0bff"; ?>
        <div class="row d-flex gs-1 mt-1 justify-content-center align-items-center">
            <div class=" col-lg-11  col-md-12 col-sm-12 d-flex align-items-center justify-start flex-column mx-auto mb-3" style="background:<?php echo $bg; ?>">
            ...
            if ($result && $result->num_rows > 0) {
                ...
                echo '<p class="alert alert-danger fs-5 text-center text-muted">No video found under Narrative Presentation.</p>';
            }
            ?>

            <div class="mt-3 col-lg-11 col-md-12 col-sm-12 d-flex align-items-center justify-start flex-column mx-auto mb-3" style="background:<?php echo $bg; ?>">
            ...
            if ($result && $result->num_rows > 0) {
                ...
                echo '<p class="alert alert-danger fs-5 text-center text-muted">No report found under Narrative Report.</p>';
            }
            ?>

            <div class=" col-lg-11 col-md-12 col-sm-12 mt-3 mb-5 d-flex align-items-center justify-start flex-column mx-auto" style="background:<?php echo $bg; ?>">
        ...
        <div class="col-lg-8 mb-3 d-flex align-items-center text-start text-center border shadow-sm p-1 mx-auto hover-container"
            ...
            <a href="../admin/handlers/' . htmlspecialchars($filePath) . '" target="_blank" class="text-decoration-none text-dark w-100 hover-link">
                <div class="drive-preview d-flex align-items-center">
                    ...
                    echo '<p class="alert alert-danger fs-5 text-center text-muted">No files found under Research & Administration Support.</p>';
                }
                ?>
            ...
            <div class="col-lg-5 mx-auto">
                ...
                <div class="drive-preview d-flex align-items-center">
                    ...
                    echo '<p class="alert alert-danger fs-5 text-center text-muted">No files found under Copyrights AVP.</p>';
                }
                ?>
            ...
            <div class="col-lg-5 mx-auto">
                ...
                <div class="drive-preview d-flex align-items-center">
                    ...
                    echo '<p class="alert alert-danger fs-5 text-center text-muted">No files found under Faculty Research Awards.</p>';
                }
                ?>
            ...
            <div class="col-lg-5 mx-auto">
                ...
                <div class="drive-preview d-flex align-items-center">
                    ...
                    echo '<p class="alert alert-danger fs-5 text-center text-muted">No files found under Student Research Awards.</p>';
                }
                ?>
            ...
            <div class="col-lg-5 mx-auto">
                ...
                <div class="drive-preview d-flex align-items-center">
                    ...
                    echo '<p class="alert alert-danger fs-5 text-center text-muted">No files found under Special Order On Institutionally Funded Research.</p>';
                }
                ?>
            ...
            <div class="col-lg-5 mx-auto">
                ...
                <div class="drive-preview d-flex align-items-center">
                    ...
                    echo '<p class="alert alert-danger fs-5 text-center text-muted">No files found under Others.</p>';
                }
                $mysqli->close();
                ?>
