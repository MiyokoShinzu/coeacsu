...
<body class="position-relative" style="overflow-x: hidden; font-family: 'Poppins', sans-serif;">
    ...
    <div class="main min-vh-100 ">
        <?php include "./ce_globals/header.php" ?>
        <?php include "./ce_globals/banner.php" ?>
        ...
        <div class="row d-flex gs-1 justify-content-center align-items-center">
            ...
            ">
                <h2 class="text-center text-secondary mt-3" style="font-weight: bolder; ">Research</h2>
                <hr class="w-25 mx-auto" style="border: 2px solid #FE904D;">
