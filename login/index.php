        ...
        <div class="container d-flex flex-column">
            ...
            <div class="row mt-5">
                <div class="col-11 col-lg-10 text-center mx-auto mt-1">
                    <img src="../assets/coea_logo.png" class="mt-3 mb-2" alt="" style="height: 100px; width: 100px; margin: auto; display: block;" class="mb-3">

                    <!-- <img src="https://1000logos.net/wp-content/uploads/2019/03/PNP-Logo.png" alt="" class="mt-3" style="height: 100px; width: 200px;"> -->

                    <h1 class="mt-2 " style="  ">College of Engineering and Architecture</h1>

                </div>
                <div class="col-sm-10 col-md-8 col-xl-5 mx-auto d-table mt-3">
