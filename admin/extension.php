...
<body>
    ...
    <div id="main">
        <nav class="breadcrumb mt-5 border-none border-start border-5 border-danger shadow-sm bg-white py-1 px-5">
            <span class="breadcrumb-item active h3" aria-current="page"><b>Extension and Community Service</b></span>
        </nav>
    ...
    <script>
        fetch(`../api/select_files.php?area=Extension`)
            .then(res => res.json())
            .then(data => {
                console.log(data);
                data.forEach(file => {
   ...
   title="Delete File"></a>
    ...
    <script>
        function uploadFile(file, section) {
            ...
            formData.append('area', 'Extension');
